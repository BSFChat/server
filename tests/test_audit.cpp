...
TEST(AuditMigration, FreshDatabaseGetsV13WithAnAppendOnlySchema) {
    ...
    // backfill onto pre-existing DMs' membership state, v19 the
    // redaction_transactions retry-dedup table, v20 users.localpart_skeleton
    // and its backfill). This test's subject remains the v13 audit_log shape
    // below.
